...
public class MyBids extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.mybids_layout, container, false);
        /**
         ...
         */
        String[] demo = {"Test2","Test2","Test2","Test2","Test2","Test2"};
        ListView test1_listview = (ListView) rootView.findViewById(R.id.mybids_listview);
