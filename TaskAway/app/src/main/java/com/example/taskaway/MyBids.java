...
public class MyBids extends Fragment{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lstTask.add(new Task("Job 4","This is a Test!","Requested","Calgary, AB",null,null,null, null));
        lstTask.add(new Task("Job 5",null,null,null,null,null,null, null));
        lstTask.add(new Task("Job 6",null,null,null,null,null,null, null));
