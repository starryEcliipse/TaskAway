...
public class AddTaskActivityTest extends ActivityInstrumentationTestCase2<AddTaskActivity> {
    ...
    public void testAddTask(){
        ...
        //Test no name input
        solo.enterText((EditText) solo.getView(R.id.viewtask_requirementsk), "Just testing purposes");
        solo.clickOnView(solo.getView(R.id.toolbar_save_btn));
        solo.assertCurrentActivity("Wrong Activity", AddTaskActivity.class);
        ...
        solo.clearEditText((EditText) solo.getView(R.id.viewtask_requirementsk));
        solo.clickOnView(solo.getView(R.id.toolbar_save_btn));
        solo.assertCurrentActivity("Wrong Activity", AddTaskActivity.class);

        //Test description greater than 300
        solo.enterText((EditText) solo.getView(R.id.viewtask_requirementsk), "So no one told you life was going to be this way. Your job's a joke, you're broke, you're love life's DOA. It's like you're always stuck in second gear, Well, it hasn't been your day, your week, your month, or even your year. But, I'll be there for you, when the rain starts to pour. I'll be there for you, like I've been there before. ");
        solo.clickOnView(solo.getView(R.id.toolbar_save_btn));
        solo.assertCurrentActivity("Wrong Activity", AddTaskActivity.class);
